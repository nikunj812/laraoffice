...
//Gryscale image converted
//https://www.positronx.io/laravel-convert-original-image-to-grayscale-image/
Route::get('/file', [PracticeController::class, 'index']);
Route::post('/upload-file', [PracticeController::class, 'imgToGreyscale'])->name('generateGrayscaleImg');
